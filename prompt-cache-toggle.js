...
(() => {
  ...
  function createMountManager({ document, ui }) {
    ...
    function findTarget() {
      return getSearchToggleAnchor() || getAnchorTarget(THINKING_BUTTON_SELECTOR, true) || getAnchorTarget(KB_BUTTON_SELECTOR, true) || getDirectButtonAnchor(VOICE_INPUT_BUTTON_SELECTOR) || getDirectButtonAnchor(UPLOAD_DOCUMENT_BUTTON_SELECTOR) || getAnchorTarget(SIDEBAR_BUTTON_SELECTOR, false);
    }
